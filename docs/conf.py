# -*- coding: utf-8 -*-
#
# pytest-example documentation build configuration file, created by
...
project = u'pytest-example'
copyright = u'2015, Paul Ross'
author = u'Paul Ross'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-example Documentation',
     [author], 1)
]
